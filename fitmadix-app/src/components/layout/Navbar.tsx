      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            ...
            className="h-9 w-60 bg-zinc-900 border border-zinc-800 rounded-lg pl-9 pr-3 text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-zinc-600 transition-colors"
          />
        </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-xs font-bold text-white transition-all cursor-pointer"
        >
        ...
        <button
          ...
          className="w-9 h-9 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white transition-colors cursor-pointer"
