...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-bold tracking-tight transition-all rounded-lg focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed select-none cursor-pointer';
  ...
  const variantStyles = {
    ...
    outline: 'bg-transparent text-white border border-zinc-800 hover:border-zinc-600 hover:bg-zinc-900/50',
