  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-4 text-left overflow-x-auto rounded-md bg-red-50 p-4">
          <pre className="text-xs text-red-900 whitespace-pre-wrap">{error.stack || error.message}</pre>
        </div>
