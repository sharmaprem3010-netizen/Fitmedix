...
function HubPage() {
  ...
  const features = [
    {
      title: t.features.aiDoctor.title,
      icon: MessageSquare,
      emoji: "💬",
      color: "bg-blue-500",
      link: "/chat",
      desc: t.features.aiDoctor.desc,
      voice: t.features.aiDoctor.voice,
    },
    {
      ...
      color: "bg-purple-500",
      link: "/prescription",
      desc: t.features.prescriptions.desc,
      voice: t.features.prescriptions.voice,
    },
    {
      title: t.features.dietScanner.title,
      icon: UtensilsCrossed,
      emoji: "🍽️",
      color: "bg-emerald-500",
      link: "/food-scan",
      desc: t.features.dietScanner.desc,
      voice: t.features.dietScanner.voice,
    },
    {
      title: t.features.nearbyHelp.title,
      icon: MapPin,
      emoji: "📍",
      color: "bg-red-500",
      link: "/nearby",
      desc: t.features.nearbyHelp.desc,
      voice: t.features.nearbyHelp.voice,
    },
    {
      title: t.features.foodLogs.title,
      icon: LineChart,
      emoji: "📊",
      color: "bg-orange-500",
      link: "/food-log",
      desc: t.features.foodLogs.desc,
      voice: t.features.foodLogs.voice,
    },
    {
      ...
      color: "bg-cyan-500",
      link: "/exercise",
      desc: t.features.workouts.desc,
      voice: t.features.workouts.voice,
    },
    {
      title: t.features.foodInfo.title,
      icon: BookOpen,
      emoji: "🍎",
      color: "bg-green-500",
      link: "/encyclopedia/food",
      desc: t.features.foodInfo.desc,
      voice: t.features.foodInfo.voice,
    },
    {
      title: t.features.medicines.title,
      icon: Pill,
      emoji: "💊",
      color: "bg-indigo-500",
      link: "/encyclopedia/medicine",
      desc: t.features.medicines.desc,
      voice: t.features.medicines.voice,
    },
    {
      title: t.features.diseases.title,
      icon: Biohazard,
      emoji: "🦠",
      color: "bg-rose-500",
      link: "/encyclopedia/disease",
      desc: t.features.diseases.desc,
      voice: t.features.diseases.voice,
    },
    {
      ...
      voice: t.features.profile.voice,
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          {features.map((f) => (
            ...
            >
              <div
                className={`grid h-16 w-16 shrink-0 place-items-center rounded-2xl ${f.color} bg-opacity-10 transition-transform group-hover:scale-110`}
              >
